(* OASIS_START *)
(* DO NOT EDIT (digest: d8ef0f9bcee240532aab2aaec6867a20) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [("fadecider", ["src"; "src/app"; "src/ramsey"], [])];
     lib_c = [];
     flags = [];
     includes =
       [
          ("src/tools", ["src"; "src/app"; "src/ramsey"]);
          ("src/ramsey", ["src"; "src/app"]);
          ("src/generators", ["src"; "src/app"; "src/ramsey"]);
          ("src/app", ["src"; "src/ramsey"]);
          ("src", ["src/app"; "src/ramsey"])
       ]
  }
  ;;
