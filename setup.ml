...
(* OASIS_START *)
(* DO NOT EDIT (digest: 26f971b4c65ab8f90798777676f0089f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/tcsprojects/fadecider";
          bugreports = None;
          synopsis =
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/tcsprojects/fadecider.git";
                      src_repo_browser =
                        Some "https://github.com/tcsprojects/fadecider";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("TCSLib", None)];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/app";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "fadecider"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "fadecider.ml"});
               Executable
                 ({
                     cs_name = "transform-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "transform.ml"});
               Executable
                 ({
                     cs_name = "subtouniv-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "subtouniv.ml"});
               Executable
                 ({
                     cs_name = "toopennwa-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "toopennwa.ml"});
               Executable
                 ({
                     cs_name = "collapse-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "collapse.ml"});
               Executable
                 ({
                     cs_name = "randomnpa-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "randomnpa.ml"});
               Executable
                 ({
                     cs_name = "randomnpvpa-bin";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "randomnpvpa.ml"})
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "5\200\2474YAF\180\152\234\162\012\220\251_\220";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
